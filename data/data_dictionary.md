...
| `loan_percent_income` | float | 0.00% | 0.00–0.83 | 0.00–0.83 | No cleaning required | Affordability / risk indicator |
...
|---|---|---|
| `dti_risk` / `dti_tier` | Loan-to-Income Ratio risk tier | Low (<20%), Medium (20–34%), High (35–49%), Critical (≥50%) |
...
| `risk_flag` | Composite Early Warning Risk Flag | `High Risk` if Grade ∈ {E,F,G} OR DTI > 40% OR Prior Default = 'Y', else `Normal` |
